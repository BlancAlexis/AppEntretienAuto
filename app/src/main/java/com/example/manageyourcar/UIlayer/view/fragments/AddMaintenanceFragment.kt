...
sealed interface onMaintenanceEvent{
    ...
    data class onMileageChanged( val newValue: MaintenanceService) : onMaintenanceEvent
    data class onMaintenanceChanged( val newValue: Int) : onMaintenanceEvent
    data class onCarChanged( val newValue: Int) : onMaintenanceEvent
